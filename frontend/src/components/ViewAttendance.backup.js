...
export default function ViewAttendance({
  ...
  // Uses total_students (class size) not total_detected (faces in photo)
  const calculateAttendanceRate = (present, totalStudents) => {
                ...
                {viewMode === 'grid' ? (
                  <div className="sessions-grid">
                    {sortedSessions.map(session => {
                      ...
                      const attendanceRate = calculateAttendanceRate(session.total_present, session.total_students || session.total_detected);
                        ...
                        >
                          ...
                          <div className="session-body">
                            <div className="session-stats">
                              ...
                              <div className="stat-item">
                                <div className="stat-number absent">{(session.total_absent ?? (session.total_students - session.total_present)) || 0}</div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="col-absent">
                            <span className="stat-number absent">{(session.total_absent ?? (session.total_students - session.total_present)) || 0}</span>
                          </div>
                    ...
                    <div className="session-info">
                      ...
                      <div className="info-card">
                        ...
                        <div className="summary-stats">
                          ...
                          <div className="summary-stat">
                            <span className="stat-number total">{session.total_students || session.total_detected || 0}</span>
